...
`)},dt={root:function(e){e.instance;var t=e.props;return["p-floatlabel",{"p-floatlabel-over":t.variant==="over","p-floatlabel-on":t.variant==="on","p-floatlabel-in":t.variant==="in"}]}},pt=he.extend({name:"floatlabel",theme:ut,classes:dt}),ht={name:"BaseFloatLabel",extends:Ye,props:{variant:{type:String,default:"over"}},style:pt,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},ft={name:"FloatLabel",extends:ht,inheritAttrs:!1};function mt(n,e,t,a,r,i){return d(),f("span",c({class:n.cx("root")},n.ptmi("root")),[D(n.$slots,"default")],16)}ft.render=mt;export{ft as a,Je as s};
